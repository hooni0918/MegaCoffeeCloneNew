...
var BestMenu = [
    ...
    MenuModel(name: "(ICE)메가초코", price: 1500, image: UIImage(named: "(ICE)메가초코") ?? UIImage(), explanation: "부드러운 우유에 진한 초코소스, 달콤한 휘핑크림의 삼박자 조화로 완성한 달콤 초코 음료.", standard: "20oz", calorie: "507.0kcal", Na: "218.0mg", sugar: "31.3g", saturatedFat: "12.0g", protein: "11.9g", caffeine: "51.8mg" ),
    ...
    MenuModel(name: "유니콘프라페마카롱", price: 4800, image: UIImage(named: "유니콘프라페마카롱") ?? UIImage(), explanation: "메가커피 인기 음료인 유니콘 프라페를 모티브로 만든 매지컬 비주얼 마카롱.", standard: "47g", calorie: "230.6kcal", Na: "32.1mg", sugar: "19.4g", saturatedFat: "5.8g", protein: "3.8g", caffeine: "0.0mg" ),
...
//
//var newBest = [
//    MenuModel(name: "", price: <#T##Int#>, image: <#T##UIImage#>, explanation: <#T##String#>, standard: <#T##String#>, calorie: <#T##String#>, Na: <#T##String#>, sugar: <#T##String#>, saturatedFat: <#T##String#>, protein: <#T##String#>, caffeine: <#T##String#>),
//    MenuModel(name: "", price: <#T##Int#>, image: <#T##UIImage#>, explanation: <#T##String#>, standard: <#T##String#>, calorie: <#T##String#>, Na: <#T##String#>, sugar: <#T##String#>, saturatedFat: <#T##String#>, protein: <#T##String#>, caffeine: <#T##String#>),
//    MenuModel(name: "", price: <#T##Int#>, image: <#T##UIImage#>, explanation: <#T##String#>, standard: <#T##String#>, calorie: <#T##String#>, Na: <#T##String#>, sugar: <#T##String#>, saturatedFat: <#T##String#>, protein: <#T##String#>, caffeine: <#T##String#>),
//    MenuModel(name: "", price: <#T##Int#>, image: <#T##UIImage#>, explanation: <#T##String#>, standard: <#T##String#>, calorie: <#T##String#>, Na: <#T##String#>, sugar: <#T##String#>, saturatedFat: <#T##String#>, protein: <#T##String#>, caffeine: <#T##String#>),
//    MenuModel(name: "", price: <#T##Int#>, image: <#T##UIImage#>, explanation: <#T##String#>, standard: <#T##String#>, calorie: <#T##String#>, Na: <#T##String#>, sugar: <#T##String#>, saturatedFat: <#T##String#>, protein: <#T##String#>, caffeine: <#T##String#>),
...
//
//var coffee = [
//    MenuModel(name: <#T##String#>, price: <#T##Int#>, image: <#T##UIImage#>, explanation: <#T##String#>, standard: <#T##String#>, calorie: <#T##String#>, Na: <#T##String#>, sugar: <#T##String#>, saturatedFat: <#T##String#>, protein: <#T##String#>, caffeine: <#T##String#>),
//    MenuModel(name: <#T##String#>, price: <#T##Int#>, image: <#T##UIImage#>, explanation: <#T##String#>, standard: <#T##String#>, calorie: <#T##String#>, Na: <#T##String#>, sugar: <#T##String#>, saturatedFat: <#T##String#>, protein: <#T##String#>, caffeine: <#T##String#>),
//    MenuModel(name: <#T##String#>, price: <#T##Int#>, image: <#T##UIImage#>, explanation: <#T##String#>, standard: <#T##String#>, calorie: <#T##String#>, Na: <#T##String#>, sugar: <#T##String#>, saturatedFat: <#T##String#>, protein: <#T##String#>, caffeine: <#T##String#>),
//    MenuModel(name: <#T##String#>, price: <#T##Int#>, image: <#T##UIImage#>, explanation: <#T##String#>, standard: <#T##String#>, calorie: <#T##String#>, Na: <#T##String#>, sugar: <#T##String#>, saturatedFat: <#T##String#>, protein: <#T##String#>, caffeine: <#T##String#>),
//    MenuModel(name: <#T##String#>, price: <#T##Int#>, image: <#T##UIImage#>, explanation: <#T##String#>, standard: <#T##String#>, calorie: <#T##String#>, Na: <#T##String#>, sugar: <#T##String#>, saturatedFat: <#T##String#>, protein: <#T##String#>, caffeine: <#T##String#>),
