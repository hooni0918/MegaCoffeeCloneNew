...
var BestMenu = [
    ...
    MenuModel(name: "(ICE)메가초코", price: 1500, image: UIImage(named: "메가초코") ?? UIImage(), explanation: "부드러운 우유에 진한 초코소스, 달콤한 휘핑크림의 삼박자 조화로 완성한 달콤 초코 음료.", standard: "20oz", calorie: "507.0kcal", Na: "218.0mg", sugar: "31.3g", saturatedFat: "12.0g", protein: "11.9g", caffeine: "51.8mg" ),
