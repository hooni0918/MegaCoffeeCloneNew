...
let menuList = [
    MenusModel(type: .set,
               menus: [MenuModel2(Image: UIImage(named: "HOT-Coldbrew") ?? UIImage(),
                                  name: "버터소금빵(프레지덩버터)세트",
                                  description: "버터소금빵 + 프레지덩 버터 + (HOT)아메리카노 = 4,700원",
                                  option: [OptionModel(essentialCount: 0,
                                                       header: "버터소금빵 선택",
                                                       details: [DetailsModel(name: "버터소금빵(프레지덩버터)",price: 0, soldOut: false, isSelect: true)]),
                                           OptionModel(essentialCount: 0,
                                                       header: "아메리카노 선택(HOT/ICE)",
                                                       details: [DetailsModel(name: "(HOT)아메리카노", price: 0, soldOut: false, isSelect: true),
                                                                 DetailsModel(name: "(ICE)아메리카노 + 500원", price: 500, soldOut: false, isSelect: false)]),
                                           OptionModel(essentialCount: 0,
                                                       header: "농도",
                                                       details: [DetailsModel(name: "선택안함", price: 0, soldOut: false, isSelect: true),
                                                                 DetailsModel(name: "연하게", price: 0, soldOut: false, isSelect: false),
                                                                 DetailsModel(name: "샷 추가 + 500원", price: 500, soldOut: false, isSelect: false),
                                                                 DetailsModel(name: "2샷 추가 + 1000원", price: 1000, soldOut: false, isSelect: false)]),
                                           OptionModel(essentialCount: 0,
                                                       header: "프레지덩버터추가구매",
                                                       details: [DetailsModel(name: "선택안함", price: 0, soldOut: false, isSelect: true),
                                                                 DetailsModel(name: "프레지덩버터 추가 + 500원", price: 500, soldOut: false, isSelect: false)])],
                                  ...
                                  price: 4700,
                                  soldOut: false),
                       MenuModel2(Image: UIImage(named: "HOT-Coldbrew") ?? UIImage(),
                                  name: "크루아상(프레지덩버터)세트",
                                  description: "크루아상 + 프레지덩 버터 + (HOT)아메리카노 = 4,700원",
                                  option: [OptionModel(essentialCount: 0,
                                                       header: "크루아상 선택",
                                                       details: [DetailsModel(name: "크루아상(프레지덩버터)",price: 0, soldOut: false, isSelect: true)]),
                                           OptionModel(essentialCount: 0,
                                                       header: "아메리카노 선택(HOT/ICE)",
                                                       details: [DetailsModel(name: "(HOT)아메리카노", price: 0, soldOut: false, isSelect: true),
                                                                 DetailsModel(name: "(ICE)아메리카노 + 500원", price: 500, soldOut: false, isSelect: false)]),
                       ...
                       MenuModel2(Image: UIImage(named: "HOT-Coldbrew") ?? UIImage(),
                                  ...
                                  option: [OptionModel(essentialCount: 0,
                                                       header: "잠봉버터블랙소금빵 선택",
                                                       details: [DetailsModel(name: "잠봉버터블랙소금빵",price: 0, soldOut: false, isSelect: true)]),
                                           OptionModel(essentialCount: 0,
                                                       header: "아메리카노 선택(HOT/ICE)",
                                                       details: [DetailsModel(name: "(HOT)아메리카노", price: 0, soldOut: false, isSelect: true),
                                                                 DetailsModel(name: "(ICE)아메리카노 + 500원", price: 500, soldOut: false, isSelect: false)]),
                                           ...
                                           OptionModel(essentialCount: 0,
                                                       header: "잼/버터 추가 구매",
                                                       details: [DetailsModel(name: "선택안함", price: 0, soldOut: false, isSelect: true),
                                                                 DetailsModel(name: "쥬에그잼(딸기) + 800원", price: 800, soldOut: false, isSelect: false),
                                                                 DetailsModel(name: "쥬에그잼(살구) + 800원", price: 800, soldOut: false, isSelect: false),
                                                                 DetailsModel(name: "프레지덩버터 추가 + 500원", price: 500, soldOut: false, isSelect: false)])],
                                  nutrition: NutritionModel(calorie: nil,
                                                            saturatedFat: nil,
                                                            sugars: nil,
                       ...
                       MenuModel2(Image: UIImage(named: "HOT-Coldbrew") ?? UIImage(),
                                  ...
                                  option: [OptionModel(essentialCount: 0,
                                                       header: "버터소금빵 선택",
                                                       details: [DetailsModel(name: "버터소금빵(쥬에그잼)",price: 0, soldOut: false, isSelect: true)]),
                                           OptionModel(essentialCount: 0,
                                                       header: "아메리카노 선택(HOT/ICE)",
                                                       details: [DetailsModel(name: "(HOT)아메리카노", price: 0, soldOut: false, isSelect: true),
                                                                 DetailsModel(name: "(ICE)아메리카노 + 500원", price: 500, soldOut: false, isSelect: false)]),
                                           ...
                                           OptionModel(essentialCount: 0,
                                                       header: "기본 제공 잼 선택",
                                                       details: [DetailsModel(name: "쥬에그잼(딸기)", price: 0, soldOut: false, isSelect: true),
                                                                 DetailsModel(name: "쥬에그잼(살구)", price: 0, soldOut: false, isSelect: false)]),
                                           OptionModel(essentialCount: 0,
                                                       header: "잼 추가 구매",
                                                       details: [DetailsModel(name: "선택안함", price: 0, soldOut: false, isSelect: true),
                                                                 DetailsModel(name: "쥬에그잼(딸기) + 800원", price: 800, soldOut: false, isSelect: false),
